...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <a href="" class="btn btn-primary mb-3 tombolTambahData" data-toggle="modal" data-target="#newSubMenuModal">Tambah Submenu</a>
                    ...
                    foreach ($subMenu as $sm) :
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('menu/deletesubmenu/' . $sm['id']) ?>" class="badge badge-warning">delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
